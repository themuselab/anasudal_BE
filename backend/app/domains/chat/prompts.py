...
GREETING = (
    "안녕하세요, 안아수달이에요. 아이 발달이 걱정될 때 **어떤 영역을 먼저 확인해보면 좋을지** "
    "공공기관 자료에서 찾아드려요.\n\n"
    "걱정되는 모습을 편하게 적어주시면 관련 자료를 근거와 함께 알려드리고, "
    "**가까운 발달재활 기관**도 추천해드릴 수 있어요.\n\n"
    "다만 저는 진단하지 않아요. 진단은 소아청소년과나 발달클리닉에서 받으셔야 해요."
)
